...
export const metadata: Metadata = createPageMetadata({
  ...
  description:
    "ThinkChains terms and conditions — engagement terms, confidentiality, intellectual property, and service policies for advisory and consulting.",
  path: "/terms",
  keywords: ["ThinkChains terms", "consulting terms", "advisory agreement"],
});
